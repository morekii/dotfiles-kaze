...
# Mis Aliases para la Kaze
alias ls='ls --color=auto -a' # Ahora ls siempre muestra lo oculto
alias ll='ls -lh'             # Lista larga con tamaño humano
alias la='ls -lAh'            # Lista larga, oculta, pero sin . y ..

fastfetch

# Función para limpiar pantalla y mostrar fastfetch
...
# Definir la función como un widget de Zsh
zle -N clear-and-fetch

# Vincular Ctrl + L a la nueva función
bindkey '^L' clear-and-fetch

# Alias para Microsoft Teams (PWA en Brave)
